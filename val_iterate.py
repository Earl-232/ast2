from markov_dp import MDP

def value_iterate(mdp, thresh):
...
if __name__ == '__main__':
    ...
    utils = value_iterate(mdp, .00001) 
    policy = optimal_policy(mdp, utils)

    print("optimal utilities final result: " + str(utils))
